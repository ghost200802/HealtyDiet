 ...
 */
const useNutritionDetails = (dietItems, totalNutrition) => {
  // 为每种营养素创建状态
    ...
    const loadNutritionData = async () => {
      ...
      try {
        ...
        const [calories, protein, carbs, fat, fiber] = await Promise.all([
          prepareNutritionData(dietItems, totalNutrition, 'calories'),
          prepareNutritionData(dietItems, totalNutrition, 'protein'),
          prepareNutritionData(dietItems, totalNutrition, 'carbs'),
          prepareNutritionData(dietItems, totalNutrition, 'fat'),
          prepareNutritionData(dietItems, totalNutrition, 'fiber')
        ]);
